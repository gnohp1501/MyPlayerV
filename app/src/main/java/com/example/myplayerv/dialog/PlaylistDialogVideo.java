...
public class PlaylistDialogVideo extends BottomSheetDialogFragment {
    private ArrayList<MediaFiles> arrayList = new ArrayList<>();
    private VideoFileTabAdapter adapter;
    private BottomSheetDialog bottomSheetDialog;
    private RecyclerView recyclerView;

    public PlaylistDialogVideo(ArrayList<MediaFiles> arrayList, VideoFileTabAdapter adapter) {
